require.config({
    ...
    paths: {
        ...
        colorpicker:'../bower/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min',
    },
    shim: {
        'datatables': ['jquery'],
...
require(['jquery', 'datatables', 'datepicker', 'bselect'], function($, DataTable, datepicker, selectpicker) {
